...
if(!isset($_SESSION['status'])){
    ...
    $dataLogin = mysqli_query($conn,"SELECT * FROM user WHERE username ='".$_SESSION['username']."' AND password='".$_SESSION['password']."' ");
    $index = mysqli_num_rows($dataLogin);
    if ($index){
...
if (isset($_GET['submit'])){
    $dataFoto = mysqli_query($conn,'SELECT * FROM photo WHERE caption ="' .$_GET['Search'].'"');
}
else
{
    ...
    <?php 
        while ($photo = mysqli_fetch_array($dataFoto)) {
            ...
            <div class="photo__info">
                ...
                <span class="photo__likes">'.$photo['liked'].'</span>
