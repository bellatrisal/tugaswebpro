...
if (isset($_POST['Submit'])) {
    ...
    mysqli_query($conn,"UPDATE profile SET name = '".$name."', username = '".$username."', website = '".$website."',  bio = '".$bio."', email = '".$email."', phonenumber = '".$phonenumber."', gender = '".$gender."' WHERE username = '".$_SESSION['username']."'");
     mysqli_query($conn,"UPDATE user SET username = '".$username."'WHERE username = '".$_SESSION['username']."'");
        ...
        <div class="edit-profile__container">
            ...
            <form action="edit-profile.php" class="edit-profile__form" method="POST">
                ...
                <div class="form__row">
                    ...
                    <input id="website" type="url" class="form__input" name="website" value="<?php echo $website ?>"/>
                </div>
                <div class="form__row">
